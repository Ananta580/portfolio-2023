  ...
  cardItems = [
    {
      ...
      class: 'group-hover:text-blue-500 text-blue-400',
    },
    {
      icon1: 'workspaces',
      icon2: '',
      label: '20+ Projects Done',
      class: 'group-hover:text-amber-500 text-amber-400',
    },
    {
      icon1: 'star',
      icon2: 'star',
      label: 'Top Rated (Upwork)',
      class: 'group-hover:text-emerald-500 text-emerald-400',
    },
    {
      icon1: 'cloudy',
      icon2: 'code',
      label: 'Coding Enthusiast',
      class: 'group-hover:text-indigo-500 text-indigo-400',
    },
  ];
