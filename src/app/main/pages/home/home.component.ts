  ...
  cardItems = [
    {
      ...
      class: 'group-hover:text-blue-500 text-red-300',
      bgClass: 'bg-blue-400',
    },
    {
      icon1: 'workspaces',
      ...
      class: 'group-hover:text-amber-500 text-red-300',
    ...
    },
    {
      ...
      class: 'group-hover:text-emerald-500 text-red-300',
    ...
    },
    {
      ...
      class: 'group-hover:text-indigo-500 text-red-300',
